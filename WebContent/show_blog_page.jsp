...
<title><%=p.getpTitle()%> || TechBlog by LearnCode with Us</title>
...
<body>
			...
			<ul class="navbar-nav mr-auto">
				<li class="nav-item active"><a class="nav-link"
					href="profile.jsp"> <span class="	fa fa-bell-o"></span>
						LearnCode with Us <span class="sr-only">(current)</span></a></li>
		...
		<div class="row my-4">
			...
			<div class="col-md-8 offset-md-2">
				...
				<div class="card">
					...
					<div class="card-body"><img class="card-img-top my-2"
						...
						<div class="row my-3 row-user">
							<div class="col-md-8">
								...
								<p class="post-user-info"><a href="#!"> <%=ud.getUserByUserId(p.getUserId()).getName()%></a>
									has posted :</p>
						</div>
						...
						<div class="post-code"><pre><%=p.getpCode()%></pre></div></div>
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					...
					<form id="add-post-form" action="AddPostServlet" method="post">
						...
						<div class="form-group"><input name="pTitle" type="text"
							placeholder="Enter post Title" class="form-control" /></div>

						<div class="form-group"><textarea name="pContent"
							class="form-control" style="height: 200px;"
							placeholder="Enter your content"></textarea></div>
						<div class="form-group"><textarea name="pCode"
							class="form-control" style="height: 200px;"
							placeholder="Enter your program (if any)"></textarea></div>
						<div class="form-group"><label>Select your pic..</label> <br>
	...
	<script src="js/show_blog_page-js.js" type="text/javascript"></script>
