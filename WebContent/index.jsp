	...
	<div class="container-fluid p-0 m-0">
		...
		<div class="jumbotron primary-background text-white banner-background">
			<div class="container">
				...
				<button class="btn btn-outline-light btn-lg"><span
					class="fa 	fa fa-user-plus"></span> Start ! its Free</button> <a
				href="login_page.jsp" class="btn btn-outline-light btn-lg"> <span
			...
			<div class="col-md-4">
				<div class="card">
					...
					<div class="card-body">
						...
						href="#" class="btn primary-background text-white">Read more</a>
				</div>
			</div>
		</div>
			<div class="col-md-4">
